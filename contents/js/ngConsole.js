                                  ...
                                  return {
                                      ...
                                      link: function(scope, element, attrs){
                                          ...
                                          scope.init = function(){
                                              ...
                                              /* Show 404 error */
                                              var lines = [
                                                  "<b>GET</b> " + document.URL + "...",
                                                  "<b>ERROR</b>: Unable to load page (404).",
                                                  "The file does not exist on this server.",
                                                  "<br>",
                                                  "If you got here with a link on the page...",
                                                  "please submit an issue at:",
                                                  "https://github.com/argarak/argarak.github.io/issues",
                                                  "<br>",
                                                  "You are now being dropped into an emergency shell.",
                                                  "Type <b>`home`</b> to go back to the home page or",
                                                  "Type <b>`help`</b> for a list of commands.",
                                                  "<b>/bin/sh</b>: can't access tty; job control turned off"
                                              ];

                                              for(var i = 0; i < lines.length; i++)
                                                  scope.printLn(lines[i]);
                                          };
                                          ...
                                          var printf = function(string){
                                              ...
                                              /* Append new command to history */
                                              document.querySelector(".console .command-list").innerHTML = prev + string;

                                              scope.scrollBottom();
                                          }

                                          scope.slowPrint = function(string) {

                                              /* Save command history */
                                              var prev = document.querySelector(".console .command-list").innerHTML;

                                              /* Append new command to history */
                                              document.querySelector(".console .command-list").innerHTML = prev + "<p>";
                                              var a = 0;
                                              var timer = setInterval(function() {
                                                  if(a == string.length)
                                                      clearInterval(timer);
                                                  else {
                                                      document.querySelector(".console .command-list").innerHTML = prev + string[a];
                                                      prev = prev + string[a];
                                                      a++;
                                                  }
                                              }, 10);
                                          ...
                                          scope.technoPrint = function() {
                                              var string = "TECHNO ";
                                              var technotimer = setInterval(function() {
                                                  /* Save command history */
                                                  var prev = document.querySelector(".console .command-list").innerHTML;
